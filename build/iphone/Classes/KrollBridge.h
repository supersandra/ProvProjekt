...
@interface ProvProjektObject : KrollCoverageObject {
#else
@interface ProvProjektObject : KrollObject {
#endif
@private
...
extern NSString * ProvProjekt$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ProvProjektObject *_provprojekt;
    KrollObject* console;
	BOOL shutdown;
