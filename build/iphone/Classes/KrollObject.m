...
//@interface ProvProjektObject : NSObject
//@end

@interface ProvProjektObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ProvProjektObject class]])
		{
			for (NSString *key in [[(ProvProjektObject*)o modules] allKeys])
			{
