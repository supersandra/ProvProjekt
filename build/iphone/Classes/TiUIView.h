...
/**
 Base class for all ProvProjekt views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ProvProjekt view hierarchy (such as wrapped iOS UIViews) was touched.
