...
// in simulator we redefine to format for ProvProjekt Developer console
...
{\
	NSString * exceptionName = [@"org.provprojekt." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.provprojekt";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIProvProjektNativeItemNone = -1, 
	UIProvProjektNativeItemSpinner = -2,
	UIProvProjektNativeItemProgressBar = -3,
	
	UIProvProjektNativeItemSlider = -4,
	UIProvProjektNativeItemSwitch = -5,
	UIProvProjektNativeItemMultiButton = -6,
	UIProvProjektNativeItemSegmented = -7,
	
	UIProvProjektNativeItemTextView = -8,
	UIProvProjektNativeItemTextField = -9,
	UIProvProjektNativeItemSearchBar = -10,
	
	UIProvProjektNativeItemPicker = -11,
	UIProvProjektNativeItemDatePicker = -12,
	
	UIProvProjektNativeItemInfoLight = -13,
	UIProvProjektNativeItemInfoDark = -14,
	
	UIProvProjektNativeItemDisclosure = -15,
	
	UIProvProjektNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ProvProjekt instances of
